...
class SignUpPage extends StatelessWidget {
  ...
  TextField _fullNameField(BuildContext context) {
    return TextField(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          TextButton(
            onPressed: () => Navigator.pushReplacementNamed(context, SignInPage.nameRoute),
            child: const Text(
              'Sign In',
              style: TextStyle(
                fontWeight: FontWeight.bold,
...
//TODO: Regex for email validation, password validation, full name validation
